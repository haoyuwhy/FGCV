...
from utils.fgcv_util import read_split_data
import data
import models
import archs
import losses
...
def create_train_val_dataloader(opt, logger):
    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train':
            ...
            dataset_opt["images_path"]=train_images_path
            dataset_opt["images_class"]=train_images_label
            dataset_opt["transform"]=data_transform["train"]
            ...
            dataset_opt["images_path"]=val_images_path
            dataset_opt["images_class"]=val_images_label
